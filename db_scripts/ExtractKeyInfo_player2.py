#!/usr/bin/env python3
"""
Extract key columns from batch-2 regular-season logs, add birthdate,
...
TARGET_PLAYERS_FILE = DATA_DIR / "target_player2_with_personId.csv"
if not TARGET_PLAYERS_FILE.exists():
    TARGET_PLAYERS_FILE = FALLBACK_DATA_DIR / "target_player2_with_personId.csv"

GAME_LOGS_FILE = OUTPUT_DIR / "player2_game_logs_regular_season.csv"
if not GAME_LOGS_FILE.exists():
    GAME_LOGS_FILE = FALLBACK_OUTPUT_DIR / "player2_game_logs_regular_season.csv"

OUTPUT_FILE = GAME_LOGS_FILE.parent / "player2_key_game_logs.csv"
